...
dnsmap 0.40 - DNS Network Mapper by github.com/pagvac
  ...
  23% [###############------------------------------------------------------] 30048/130225 | found:0 | 505.6/s | eta:3m1[info] OpenAI yielded 665 labels, of which 560 are new
  23% [###############------------------------------------------------------] 30216/130951 | found:0 | 508.4/s | eta:3m1[info] brute-force target count: 100735 (+28 from scraping, +558 from OpenAI)
...
cli.github.com
[stats] duration=198.43s attempted=100735 found=44 openai_found=6 scrape_found=10 avg_per_sec=507.67
```
...
If an `OPENAI_API_KEY` environment variable is present, dnsmap will also query
OpenAI for candidate labels, fold those into the brute-force queue, and apply
the same duplicate filtering and telemetry you see for the built-in sources.
